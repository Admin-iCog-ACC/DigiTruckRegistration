...
function BackgroundSection() {
  return (
    <>
      <div className="w-full mx-auto bg-white shadow-md  px-5 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-3 py-10 lg:pl-10">
      ...
      {/* <div className="relative h-24 mt-14 md:mb-1 md:mx-2 ">
        <Image layout="fill" objectFit="contain" alt="" src="/home.png" />
      </div> */}

      <div className="relative mt-14 h-[83px] mb-10    ">
        <Image
          className=""
          layout="fill"
          objectFit="cover"
