  ...
  const handleChange = (e) => {
    ...
    setUserData({
      ...
      [name]: {
        value,
        required,
        error: required ? validateInputs(name, value, locale) : name === "contactPhone" || name === "contactOtherPhone" ? validateInputs(name, value, locale) : null,
      },
    });
  };
  return (
    <div className=" ">
      ...
      <div className="flex gap-10">
        ...
        <p className="text-xs text-red-500">{userData["contactPhone"]?.error}</p>
        ...
        <p className="text-xs text-red-500">{userData["contactOtherPhone"]?.error}</p>
