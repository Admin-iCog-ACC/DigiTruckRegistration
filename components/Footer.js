...
import igg from "../public/Logo.png";
function Footer() {
  const isLarge = useMediaQuery("(min-width: 970px)");
  return (
    <div className="w-full bg-[#f8f9fas] border-b-1">
      <div className="p-10 flex justify-center items-center">
        <div className="space-y-7 space-x-3 py-5">
          <div>
            <h2 className="text-[#000000] font-bold text-2xl flex justify-center">
          ...
          <div className="border-2 p-1 border-[#e7ebf5] bg-white  flex">
            ...
            <button
              type="submit"
              className="bg-[#000000] text-white px-5 md:px-8 py-2.5 rounded-md"
            >
              Subscribe
            </button>
          </div>
          ...
          <div className=" flex flex-wrap lg:gap-10 gap-5 ">
            <div className="text-sm w-full md:w-2/6 lg:py-10 py-5 mx-5 lg:mx-none">
              ...
              <div className="mb-4 text-md text-gray-500">
                iCog, previously known as ( iCog Anyone Can Code (iCog-ACC)) is
                an affiliate of iCog Labs.
                <br />
                <br />
                iCog believes technology should be accessible to all, and young
                people are crucial to unlocking its potential. Our mission is to
                democratize technology through training, consultancy, and
                innovative products, enabling the next generation to shape the
                future.
              </div>
              <div className="flex space-x-1">
                <p className="text-bold">Follow us on: </p>
                <span className="text-[0000F1] space-x-1">
            ...
            <div className="text-[#000000] lg:py-10 py-5 mx-5 md:w-[10%] lg:mx-none">
            ...
            >
              <h3 className="font-semibold text-[#000000] lg:pt-8 pt-3 text-base mb-3">
                CONTACT US
              </h3>
              <div
                className={` ${
