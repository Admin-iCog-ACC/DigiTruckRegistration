    ...
    <div className="w-full bg-[#f6f9ff] border-b-1">
      <div className="p-10 flex justify-center items-center">
        <div className="space-y-7 space-x-3 py-5">
          <div>
            <h2 className="text-[#000] font-bold text-2xl flex justify-center">
          ...
          <div className="border-2 p-1 border-[#e7ebf5] bg-white  flex">
            ...
            <button
              type="submit"
              className="bg-[#000] text-white px-5 md:px-8 py-2.5 rounded-md"
            >
              Subscribe
            </button>
          </div>
          ...
          <div className=" flex flex-wrap lg:gap-10 gap-5 ">
            <div className="text-sm w-full md:w-2/6 lg:py-10 py-5 mx-5 lg:mx-none">
              ...
              <div className="flex space-x-1">
                ...
                <span className="text-black space-x-1">
            ...
            <div className="text-[#000] lg:py-10 py-5 mx-5 md:w-[10%] lg:mx-none">
            ...
            >
              <h3 className="font-semibold text-[#000] lg:pt-8 pt-3 text-base mb-3">
                CONTACT US
              </h3>
              <div
                className={` ${
