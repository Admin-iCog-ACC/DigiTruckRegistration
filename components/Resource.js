...
function Resources() {
  return (
    <div>
      ...
      <div className="p-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5 gap-y-12 px-16 py-10">
        <a
          href="https://docs.google.com/forms/d/1rH3Lol04VAnWpRb982xRDSKHYkNgAoUowf3FZaMxsYw/viewform?edit_requested=true"
          // target="_blank"
        >
          <div className="group flex flex-col justify-center items-center hover:shadow-2xl shadow-lg py-5 ">
